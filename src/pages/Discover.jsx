      ...
      <div className="w-[320px] h-[450px] z-30 mt-4">
        ...
        >
          ...
          {profiles.slice(0, 12).map((p) => (
            ...
            <SwiperSlide key={p.id} className="rounded-[45px] border-4 border-white shadow-2xl bg-white overflow-hidden shadow-2xl border-4 border-white">
